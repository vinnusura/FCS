...
class WarehouseRepositoryTest {
    ...
    void testCreateAndFind() {
        ...
        Warehouse found = warehouseRepository.findByBusinessUnitCode("MW1");
        assertNotNull(found);
    ...
    void testUpdate() {
        ...
        Warehouse updated = warehouseRepository.findByBusinessUnitCode("MW2");
    ...
    void testRemove() {
        ...
        warehouseRepository.create(warehouse);
        assertNotNull(warehouseRepository.findByBusinessUnitCode("MW3"));

        warehouseRepository.remove(warehouse);
        assertNull(warehouseRepository.findByBusinessUnitCode("MW3"));
    }
