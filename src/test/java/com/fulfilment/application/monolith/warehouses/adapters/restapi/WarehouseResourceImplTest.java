...
class WarehouseResourceImplTest {
    ...
    void createANewWarehouseUnit_Success() {
        ...
        when(warehouseRepository.findByBusinessUnitCode("BU1")).thenReturn(domainWarehouse);
    ...
    void getAWarehouseUnitByID_Success() {
        Warehouse w = new Warehouse();
        w.businessUnitCode = "BU1";
        when(warehouseRepository.findByBusinessUnitCode("BU1")).thenReturn(w);
    ...
    void getAWarehouseUnitByID_NotFound() {
        when(warehouseRepository.findByBusinessUnitCode("BU1")).thenReturn(null);
    ...
    void replaceTheCurrentActiveWarehouse_Success() {
        ...
        when(warehouseRepository.findByBusinessUnitCode("BU2")).thenReturn(w);
